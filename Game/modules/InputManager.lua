...
function FireProj(mouse_x, mouse_y, speed)
    ...
    local proj_char = 'x'
    globals.temp_objects.bullets[globals.next_id] = CreateProj(proj_char,globals.perm_objects.Player.x_offset,globals.perm_objects.Player.y_offset,
          globals.next_id,speed,mouse_x,mouse_y)
